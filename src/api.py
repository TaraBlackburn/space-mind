...
class Cortex(Dispatcher):
    ...
    def request_access(self):
        ...
        request_access_request = {
            ...
            "params": {
                "clientId": self.user['3JdlegpDdY6YqyeiEXZvX5J7Pb6pnxDXY6aI1tdZ'], 
                "clientSecret": self.user['MHz1aJxXHoANskYuKz0tbh1qwuuJUaNorq8r3D3IiCLyZTuVUstRgYHSEiBPGcRFoFU7Tn7s0WZzN0c4YhogKHN2n53IeFRa4gRNl0A3VkJ7X7Ts2lSBkqjBzp2vKnpa']
            },
